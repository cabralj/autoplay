...
entity logoBody { type = <sprites\\body.mdl>; x = 300; y = 0; z = 10; layer = 9;}
entity logoHead { type = <sprites\\head.mdl>; x = 300; y = 0; z = 10; layer = 9;}
//entity logoPosi { type = <position.mdl>; x = 200; y = 0; z = 10; layer = 9; flags=visible;}
